...
function setNavbar(){window.innerWidth<=xs?($(".main-nav").removeClass("navbar-fixed-top"),$(".main-nav").addClass("navbar-static-top")):($(".main-nav").removeClass("navbar-static-top"),$(".main-nav").addClass("navbar-fixed-top"))}var xs=767;$(document).ready(function(){setNavbar()}),$(window).resize(function(){setNavbar()}),$("#side-nav").affix({offset:{top:$("#side-nav").offset().top+$(".page-head").outerHeight(!0),bottom:$("footer").outerHeight(!0)+40}});